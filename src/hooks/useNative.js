...
// (ex.: app foi relançado pelo deep link e o usuário ainda não clicou em Google)
export const consomeCallbackPendente = () => {
  if (ultimoCallback) {
    const url = ultimoCallback;
    ultimoCallback = null;
    return url;
  }
  return null;
